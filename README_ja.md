...
<div align="center">
  <img src="screenshots/main.png" width="250" alt="メイン画面"/>
  <img src="screenshots/settings.png" width="250" alt="設定画面"/>
  <img src="screenshots/wallpaper.png" width="250" alt="壁紙設定"/>
</div>
...
### 翻訳貢献
現在、中国語と英語をサポートしています。他の言語の翻訳を歓迎します！
...
### v1.1.0 (予定)
- [ ] ウィジェットサポート（天気、カレンダー、音楽など）
- [ ] ジェスチャーコントロール（ダブルタップ、スワイプなど）
- [ ] アプリグループとフォルダ
- [ ] より多くのテーマとアイコンパック
...
- [ ] プラグインシステム
- [ ] クロスデバイス同期
- [ ] 高度なAIアシスタント機能（スケジュール管理、メール処理など）
- [ ] タブレットと折りたたみ画面の最適化
