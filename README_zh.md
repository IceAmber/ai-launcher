...
AI Launcher 是一款基于大语言模型（LLM）的 Android 智能桌面启动器，让用户通过自然语言和语音指令操作手机、启动应用，并将传统桌面升级为能够理解用户意图的智能入口。
...
<div align="center">
  <img src="screenshots/demo.gif" alt="AI Launcher 演示" width="300"/>
</div>
...
### 方式一：从 Releases 下载
前往 [Releases 页面](https://github.com/IceAmber/ai-launcher/releases) 下载最新 APK
